...
class SubscriptionManager(object):
    ...
    def _start_subscribe_loop(self):
        ...
        def callback(raw_result, status):
            ...
            if status.is_error():
                if status.category is PNStatusCategory.PNTimeoutCategory:
                    self._start_subscribe_loop()
                else:
